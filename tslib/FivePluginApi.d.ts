...
}, "classes" | "children" | "className" | "style" | "tabIndex" | "button" | "alignItems" | "sx" | "action" | "autoFocus" | "disabled" | "selected" | "centerRipple" | "disableRipple" | "disableTouchRipple" | "focusRipple" | "focusVisibleClassName" | "LinkComponent" | "onFocusVisible" | "TouchRippleProps" | "touchRippleRef" | "slotProps" | "slots" | "components" | "componentsProps" | "ContainerComponent" | "ContainerProps" | "dense" | "disableGutters" | "disablePadding" | "divider" | "secondaryAction">) => JSX.Element) & import("@mui/material/OverridableComponent").OverridableComponent<import("@mui/material").ExtendButtonBaseTypeMap<import("@mui/material/ListItem").ListItemTypeMap<{
    button: true;
