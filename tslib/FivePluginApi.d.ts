...
}, "className" | "style" | "classes" | "children" | "disableGutters" | "sx" | "button" | "tabIndex" | "action" | "autoFocus" | "disabled" | "selected" | "alignItems" | "centerRipple" | "disableRipple" | "disableTouchRipple" | "focusRipple" | "focusVisibleClassName" | "LinkComponent" | "onFocusVisible" | "TouchRippleProps" | "touchRippleRef" | "slotProps" | "slots" | "components" | "componentsProps" | "ContainerComponent" | "ContainerProps" | "dense" | "disablePadding" | "divider" | "secondaryAction">) => JSX.Element) & import("@mui/material/OverridableComponent").OverridableComponent<import("@mui/material").ExtendButtonBaseTypeMap<import("@mui/material/ListItem").ListItemTypeMap<{
    button: true;
